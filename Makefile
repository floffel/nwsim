...
#  opp_makemake --nolink -f --deep -O out -KVEINS_PROJ=/home/veins/src/veins -DVEINS_IMPORT -I. -I$$\(VEINS_PROJ\)/src -Isrc -L$$\(VEINS_PROJ\)/src -Lout/$$\(CONFIGNAME\)/src -lveins$$\(D\) -d src -X.
#
